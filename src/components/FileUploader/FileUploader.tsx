...
const FileUploader = ({
  ...
  return (
    <div
      className={[
        "itauros-ui-file-uploader-drop-zone-wrapper",
        isDropActive ? "itauros-ui-file-uploader-drop-zone-active" : "",
        disabled ? "itauros-ui-file-uploader-drop-zone-disabled" : "",
      ].join(" ")}
      {...props}
    >
      <div
      ...
      >
        ...
        />
        <div
          className={`itauros-ui-file-uploader-text ${
            disabled && "itauros-ui-file-uploader-text-disabled"
          }`}
        >
          Drop your file here
        </div>
        <UploadIcon
          ...
          className="itauros-ui-file-uploader-upload-icon"
        />
      </div>
      <ul className="itauros-ui-file-uploader-list-files">
        {showList &&
          files?.map((file: File) => (
            <li key={`${file.name}_${file.lastModified}`}>
              <span className="itauros-ui-file-uploader-text-file-span">
